...
public class RentACatImpl implements RentACat {
     ...
     * passed-in cat id. If the cat with the id exists in the list of cats and
     * has been rented out, then this method should return true after calling
     ...
     * passed-in cat id. If the cat with the id exists in the list of cats and
     * has *not* been rented out, then this method should return true after
     * calling .rentCat() on that cat. Otherwise, the method should return
     * false.
     *
     * @param id the ID of the cat to rent
     ...
     * passed-in cat id, if the cat exists, and then returns true. If the cat
    ...
    public boolean renameCat(int id, String name) {
        ...
        currname.renameCat(name);
        return true;
    }

    /**
     * Create a String list from the list of cats using the .toString() method
     * of each NON-RENTED Cat object in the list. That is, it should only add
     * cats who are available to be rented. These cats should be separated by
     * "\n" characters (line feeds). Example: ID 1. Jennyanydots ID 2. Old
     * Deuteronomy ID 3. Mistoffelees
     *
    ...
    /**
     * Given an id, return a reference to the specified cat if a cat with that
     * ID exists. Return null if no cat of that ID exists in the list.
     *
